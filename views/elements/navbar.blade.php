                ...
                <div class="media mr-lg-5 align-items-center">
                    ...
                    <div class="media-body">
                        @if($server && $server->isOnline())
                            <div data-toggle="tooltip" title="{{ trans('messages.actions.copy') }}" data-copy-target="address" data-copied-messages="{{ implode('|', trans('theme::balkoura.clipboard')) }}">
                            ...
                            {{ trans_choice('theme::balkoura.header.online', $server->getOnlinePlayers()) }}
                        @else
                            <h5 class="mb-0">{{ trans('theme::balkoura.header.offline') }}</h5>
                        @endif
                    </div>
                </div>
            </div>
